...
class TestCase:
    ...
    def test_invoke_handler_run_type_prepare_export(self):
        ...
        message = monkey_patch.patch.sqs().mysqs.get_queue('prepare-queue').get_message()['message']
        assert monkey_patch.patch.sqs().mysqs.get_queue('prepare-queue').get_message() is None
